...
void main()
{
    ...
    vec4 emission = checkCode(lighting_code, light_bright_code) ? vec4(1.0) : checkCode(texturing_code, emission_code) ? texture(emission_map, getScaledTexture()) : vec4(vec3(0.0), 1.0);
