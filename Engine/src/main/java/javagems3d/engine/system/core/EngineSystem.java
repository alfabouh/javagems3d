...
package javagems3d.engine.system.core;
...
import javagems3d.engine.system.core.player.LocalPlayer;
...
import toolbox.map_sys.save.objects.map_prop.FogProp;
import toolbox.map_sys.save.objects.map_prop.SkyProp;
