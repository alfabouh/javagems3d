...
public class RenderTable implements ICopyable<RenderTable> {
    ...
    public static JGemsShaderManager DEFAULT_SPOT_L_SHADOW_MAP_SHADER = null;
    ...
    public static void SET_DEFAULT_SHADERS_INDIRECT(@NotNull JGemsShaderManager DEFAULT_SCENE_SHADER_IND, @NotNull JGemsShaderManager DEFAULT_BACKGROUND_SHADER_IND, @NotNull JGemsShaderManager DEFAULT_SUN_L_SHADOW_MAP_SHADER_IND, @NotNull JGemsShaderManager DEFAULT_POINT_L_SHADOW_MAP_SHADER_IND, @NotNull JGemsShaderManager DEFAULT_SPOT_L_SHADOW_MAP_SHADER_IND, @NotNull JGemsShaderManager DEFAULT_BLENDED_TRANSPARENCY_SHADER_IND) {
        ...
        RenderTable.DEFAULT_SPOT_L_SHADOW_MAP_SHADER_IND = DEFAULT_SPOT_L_SHADOW_MAP_SHADER_IND;
        RenderTable.DEFAULT_TRANSPARENCY_SHADER_IND = DEFAULT_BLENDED_TRANSPARENCY_SHADER_IND;
    }

    public static void SET_DEFAULT_SHADERS_DIRECT(@NotNull JGemsShaderManager DEFAULT_SCENE_SHADER, @NotNull JGemsShaderManager DEFAULT_BACKGROUND_SHADER, @NotNull JGemsShaderManager DEFAULT_SUN_L_SHADOW_MAP_SHADER, @NotNull JGemsShaderManager DEFAULT_POINT_L_SHADOW_MAP_SHADER, @NotNull JGemsShaderManager DEFAULT_SPOT_L_SHADOW_MAP_SHADER, @NotNull JGemsShaderManager DEFAULT_BLENDED_TRANSPARENCY_SHADER) {
        ...
        RenderTable.DEFAULT_SPOT_L_SHADOW_MAP_SHADER = DEFAULT_SPOT_L_SHADOW_MAP_SHADER;
    ...
    public RenderTable setDefaultTableValues(boolean indirect) {
        if (indirect) {
            this.setMatch(Pipeline.SOLID_SCENE, RenderTable.DEFAULT_SCENE_SHADER_IND, RenderTable.DEFAULT_SCENE_RENDER_FABRIC_IND);
            ...
            this.setMatch(Pipeline.SPOT_LIGHT_SHADOW_MAP, RenderTable.DEFAULT_SPOT_L_SHADOW_MAP_SHADER_IND, RenderTable.DEFAULT_SHADOW_RENDER_FABRIC_IND);
            ...
            this.setMatch(Pipeline.SOLID_SCENE, RenderTable.DEFAULT_SCENE_SHADER, RenderTable.DEFAULT_SCENE_RENDER_FABRIC);
            ...
            this.setMatch(Pipeline.SPOT_LIGHT_SHADOW_MAP, RenderTable.DEFAULT_SPOT_L_SHADOW_MAP_SHADER, RenderTable.DEFAULT_SHADOW_RENDER_FABRIC);
