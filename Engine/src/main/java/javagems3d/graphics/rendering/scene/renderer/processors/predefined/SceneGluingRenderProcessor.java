...
public class SceneGluingRenderProcessor extends IRenderProcessor.Template {
    ...
    public void createResources() {
        ...
        this.glued.createFrameBuffer2DTexture(this.getOpenGLRenderer().getRenderingResolution(), glued1, false, GL46.GL_NEAREST, GL46.GL_COMPARE_REF_TO_TEXTURE, GL46.GL_LESS, GL46.GL_CLAMP_TO_EDGE, null);
    }
    ...
    public void onRender(FrameTicking frameTicking) {
        ...
        this.getDeferredRenderNode().getOutFboGBuffer().copyFBOtoFBOColor(this.getGluedScene().getFrameBufferId(), new Pair[]{new Pair<>(GL46.GL_COLOR_ATTACHMENT2, GL46.GL_COLOR_ATTACHMENT0)}, this.getOpenGLRenderer().getRenderingResolution());
