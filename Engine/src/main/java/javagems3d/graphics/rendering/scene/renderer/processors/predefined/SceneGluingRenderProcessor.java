...
public class SceneGluingRenderProcessor extends IRenderProcessor.Template {
    ...
    public void onRender(FrameTicking frameTicking) {
        ...
        this.getDeferredRenderNode().getOutFboGBuffer().copyFBOtoFBOColor(this.getGluedScene().getFrameBufferId(), new Pair[]{new Pair<>(GL46.GL_COLOR_ATTACHMENT1, GL46.GL_COLOR_ATTACHMENT0)}, this.getOpenGLRenderer().getRenderingResolution());
