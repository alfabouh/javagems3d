...
import javagems3d.graphics.opengl.rendering.programs.textures.TextureProgram;
import javagems3d.graphics.opengl.rendering.scene.base.ISceneRenderer;
...
import javagems3d.graphics.opengl.rendering.scene.render_base.groups.deferred.WorldDeferredRender;
import javagems3d.graphics.opengl.rendering.scene.render_base.groups.forward.*;
import javagems3d.graphics.opengl.rendering.scene.render_base.groups.transparent.LiquidsRender;
import javagems3d.graphics.opengl.rendering.scene.render_base.groups.transparent.ParticlesRender;
...
public class JGemsOpenGLRenderer implements ISceneRenderer {
    ...
    private void blurBloomBuffer(Model<Format2D> model, Vector2i windowSize) {
        ...
        blurShader.bind();
        blurShader.performUniform(new UniformString("resolution"), DefaultUniformActions.VEC2I(new Vector2i(windowSize).div(2.0f)));
