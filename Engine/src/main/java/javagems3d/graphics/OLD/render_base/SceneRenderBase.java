...
package javagems3d.graphics.OLD.render_base;
...
public abstract class SceneRenderBase {
    ...
    private final JGemsOpenGLRendererOLD sceneRender;

    protected SceneRenderBase(int renderOrder, JGemsOpenGLRendererOLD sceneRender, RenderGroup renderGroup) {
    ...
    public JGemsOpenGLRendererOLD getSceneRenderer() {
