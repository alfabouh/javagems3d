...
public class TextureSample implements ITextureSample {
    ...
    private void setTextureParams(Params params) {
        ...
        GL46.glTexParameteri(GL46.GL_TEXTURE_2D, GL46.GL_TEXTURE_WRAP_S, params.isRepeat() ? GL46.GL_REPEAT : GL46.GL_CLAMP_TO_EDGE);
        GL46.glTexParameteri(GL46.GL_TEXTURE_2D, GL46.GL_TEXTURE_WRAP_T, params.isRepeat() ? GL46.GL_REPEAT : GL46.GL_CLAMP_TO_EDGE);
        if (anisotropic) {
