...
public class ModelAssetsInitializer implements IAssetsInitializer {
    ...
    public void load(SystemResources systemResources) {
        ...
        this.grassCube = systemResources.createMeshBuffer(new JGemsPath(JGems3D.DEFAULT_PATHS.MODELS, "sponza/sponza.obj"), ModelLoaderFlags.DEFAULT, false);
        ...
        this.test_anim = systemResources.createMeshBuffer(new JGemsPath(JGems3D.DEFAULT_PATHS.MODELS, "cube/cube.obj"), ModelLoaderFlags.DEFAULT, false);
