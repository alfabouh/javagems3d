...
public final class BasicShadersInitializer extends ShadersInitializer<JGemsShaderManager> {
    ...
    protected void initObjects(ResourceCache resourceCache) {
        ...
        this.background = this.createShaderManager(resourceCache, new JGemsPath(JGems3D.PATHS.SHADERS, "world/background")).attachUBOs(this.SunLight, this.Fog);
        this.background_indirect = this.createShaderManager(resourceCache, new JGemsPath(JGems3D.PATHS.SHADERS, "world/background_indirect")).attachUBOs(this.SunLight, this.Fog);
        ...
        this.weighted_oit_indirect = this.createShaderManager(resourceCache, new JGemsPath(JGems3D.PATHS.SHADERS, "oit/weighted_oit_indirect")).attachUBOs(this.SunLight, this.PointLights, this.Fog);
