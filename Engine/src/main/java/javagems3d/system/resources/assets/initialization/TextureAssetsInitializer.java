...
public class TextureAssetsInitializer implements IAssetsInitializer {
    ...
    public void load(GameResources gameResources) {
        ...
        this.skyboxCubeMap = gameResources.createCubeMapTexture(null, new JGemsPath(JGems3D.DEF_PATHS.CUBE_MAPS, "skyDay", "sky_"), "png", new CubeMapTexture.Properties(true));
        this.skyboxCubeMap2 = gameResources.createCubeMapTexture(null, new JGemsPath(JGems3D.DEF_PATHS.CUBE_MAPS, "skyNight", "sky_"), "bmp", new CubeMapTexture.Properties(true));
    }
