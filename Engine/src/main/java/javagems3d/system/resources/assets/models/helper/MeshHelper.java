...
public abstract class MeshHelper {
    ...
    public static Model3D generateSimplePlane3DModel(Vector3f v1, Vector3f v2, Vector3f v3, Vector3f v4) {
        SimplePlaneModel3D planeModel3D = new SimplePlaneModel3D(v1, v2, v3, v4);
        return planeModel3D.generateModel();
    }

    public static Model3D generatePlane3DModel(Vector3f v1, Vector3f v2, Vector3f v3, Vector3f v4) {
    ...
    public static RenderMesh generatePlane3DMesh(Vector3f v1, Vector3f v2, Vector3f v3, Vector3f v4) {
        PlaneModel3D planeModel3D = new PlaneModel3D(v1, v2, v3, v4);
        return planeModel3D.generateMesh();
    }

    public static RenderMesh generateSimplePlane3DMesh(Vector3f v1, Vector3f v2, Vector3f v3, Vector3f v4) {
        SimplePlaneModel3D planeModel3D = new SimplePlaneModel3D(v1, v2, v3, v4);
        return planeModel3D.generateMesh();
    }
