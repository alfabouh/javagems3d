...
public final class ParticleTexturesPack {
    ...
    private final @NotNull JGems3D.GetSource source;

    public ParticleTexturesPack(@NotNull JGems3D.GetSource source, JGemsPath pathToTexturePath, String format, int texturesNum, float animationRateSeconds) {
