...
public abstract class JGemsConfig {
    ...
    public static abstract class SYSTEM {
        ...
        public static int MAX_INDIRECT_SCENE_OBJ_RENDERING_MESH_PROPERTIES = 1024 * JGemsConfig.SYSTEM.INDIRECT_SSBO_SIZE_MUL;
        public static int MAX_INDIRECT_SCENE_OBJ_RENDERING_MESH_MATERIALS = 2048 * JGemsConfig.SYSTEM.INDIRECT_SSBO_SIZE_MUL;
