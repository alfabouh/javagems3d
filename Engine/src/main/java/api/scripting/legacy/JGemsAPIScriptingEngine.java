...
import api.scripting.legacy.classes.global.GlobalJS;
import api.scripting.legacy.classes.init.InitializationJS;
import api.scripting.legacy.classes.init.logging.LogJS;
import api.scripting.legacy.classes.util.Vec3f;
import api.scripting.legacy.classes.util.Vec4f;
