package api.scripting.legacy.classes.global;

import api.scripting.legacy.classes.global.timer.TimerCallbackJS;
import api.scripting.legacy.classes.world.GameWorldJS;
import api.scripting.legacy.classes.world.ObjectJS;
import api.scripting.legacy.classes.world.objects.*;
