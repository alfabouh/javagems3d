package api.scripting.legacy.classes.world;

import api.scripting.legacy.JGemsAPIScriptingManaging;
import api.scripting.legacy.classes.global.timer.TimerManagerJS;
...
import api.scripting.legacy.classes.world.background.BackgroundJS;
import api.scripting.legacy.classes.world.environment.EnvironmentJS;
import api.scripting.legacy.classes.world.objects.EntityJS;
import api.scripting.legacy.classes.world.objects.PointLightJS;
import api.scripting.legacy.classes.world.objects.PropJS;
import api.scripting.legacy.classes.world.objects.UtilsJS;
