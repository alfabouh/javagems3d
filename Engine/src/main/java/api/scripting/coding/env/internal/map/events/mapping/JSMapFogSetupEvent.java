...
@JSCodingClass(binding = "JSMapFogSetupEvent", description = "Event triggered when fog data is set up in the scene.")
public class JSMapFogSetupEvent implements JSEventCancellableI {
    @JSHideFromDoc
    ...
    public JSMapFogSetupEvent() {
    }

    @JSHideFromDoc
    public JSMapFogSetupEvent(JSSceneWorld jsSceneWorld, JSEnvironment jsEnvironment) {
    ...
    @JSHideFromDoc
    @Override
    public String name() { return "JSMapFogSetupEvent"; }
}