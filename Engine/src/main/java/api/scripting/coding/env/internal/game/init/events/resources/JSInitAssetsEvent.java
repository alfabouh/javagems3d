...
public class JSInitAssetsEvent implements JSEventI {
    ...
    @JSCodingFunctionOrMethod(description = "...", paramNames = {"pathToGLTF2Model", "keepNodesInMemory"})
    ...
    @JSCodingFunctionOrMethod(description = "...", paramNames = {"pathToGLTF2Model"})
    ...
    @JSCodingFunctionOrMethod(description = "...", paramNames = {"pathToTexture", "textureProperties"})
    ...
    @JSCodingFunctionOrMethod(description = "...", paramNames = {"pathToTexture"})
    ...
    @JSCodingFunctionOrMethod(description = "...", paramNames = {"pathToTextureUP", "pathToTextureDOWN", "pathToTextureFRONT", "pathToTextureBACK", "pathToTextureLEFT", "pathToTextureRIGHT", "cubeMapProperties"})
    ...
    @JSCodingFunctionOrMethod(description = "...", paramNames = {"pathToTextureUP", "pathToTextureDOWN", "pathToTextureFRONT", "pathToTextureBACK", "pathToTextureLEFT", "pathToTextureRIGHT"})
    ...
    @JSCodingFunctionOrMethod(description = "...", paramNames = {"pathToTTFFont", "fontStyles, fontSize"})
