...
import javagems3d.engine.graphics.opengl.rendering.programs.textures.TextureProgram;
import javagems3d.engine.graphics.opengl.rendering.scene.base.ISceneRenderer;
...
import javagems3d.engine.graphics.opengl.rendering.scene.render_base.groups.deferred.WorldDeferredRender;
import javagems3d.engine.graphics.opengl.rendering.scene.render_base.groups.forward.*;
import javagems3d.engine.graphics.opengl.rendering.scene.render_base.groups.transparent.LiquidsRender;
import javagems3d.engine.graphics.opengl.rendering.scene.render_base.groups.transparent.ParticlesRender;
import javagems3d.engine.graphics.opengl.rendering.scene.render_base.groups.transparent.WorldTransparentRender;
