...
public class ItemCross extends InventoryItem {
    ...
    public void onLeftClick(IWorld world) {
        for (int i = 0; i < 16; i++) {
            ...
            JGemsHelper.PARTICLES.emitParticle(JGemsHelper.PARTICLES.createSimpleColoredParticle(ParticleAttributes.defaultParticleAttributes(), color, pos, new Vector2f(0.3f)));
        }
