...
public abstract class AppManager {
    ...
    public abstract void placeObjectInTBoxMap(SceneWorld sceneWorld, PhysicsWorld physicsWorld, GameResources localGameResources, String id, ObjectCategory objectCategory, AttributeContainer attributeContainer, TRenderContainer renderContainer);
