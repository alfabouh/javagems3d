...
public class ModeledObject3DRenderer implements ITBoxObjectRenderer {
    ...
    public void onRender(MapProperties properties, TBoxScene3DObject tBoxScene3DObject, float deltaTime) {
        ...
        tBoxScene3DObject.getRenderData().getShaderManager().performUniform("diffuse_color", new Vector3f(1.0f));
        tBoxScene3DObject.getRenderData().getShaderManager().performUniform("use_texturing", true);
