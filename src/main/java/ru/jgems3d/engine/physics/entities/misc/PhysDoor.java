package ru.jgems3d.engine.physics.entities.misc;
...
public class PhysDoor extends WorldItem implements IWorldTicked {
    ...
    public PhysDoor(PhysicsWorld world, @NotNull Vector3f pos, @NotNull Vector3f rot, String itemName, boolean reversedOpening) {
