...
public class DefaultLeaveConfirmationPanel extends AbstractPanelUI {
    ...
    public void drawPanel(ImmediateUI immediateUI, float partialTicks) {
        ...
        immediateUI.buttonUI(JGems.get().I18n("menu.confirm.yes"), JGemsResourceManager.globalTextureAssets.standardFont, new Vector2i(windowW / 2 + 5, windowH / 2), new Vector2i(200, 60), 0xffffff, 0.5f)
                .setOnClick(() -> {
                    JGems.get().destroyGame();
                });
        immediateUI.buttonUI(JGems.get().I18n("menu.confirm.no"), JGemsResourceManager.globalTextureAssets.standardFont, new Vector2i(windowW / 2 - 205, windowH / 2), new Vector2i(200, 60), 0xffffff, 0.5f)
                .setOnClick(() -> {
