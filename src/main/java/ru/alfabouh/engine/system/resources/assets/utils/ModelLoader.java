package ru.alfabouh.engine.system.resources.assets.utils;
...
public class ModelLoader {
    ...
    private static MeshDataGroup loadMesh(String modelPath, String modelName) {
        JGems.get().getLogManager().log("Loading model " + modelPath + modelName);
        ...
        if (JGems.seekInJar(modelPath + modelName)) {
            ...
            JGems.get().getLogManager().warn("Couldn't find " + modelPath);
            return null;
        }
