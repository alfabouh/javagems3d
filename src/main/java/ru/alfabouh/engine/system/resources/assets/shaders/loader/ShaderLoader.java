package ru.alfabouh.engine.system.resources.assets.shaders.loader;

import ru.alfabouh.engine.JGems;
import ru.alfabouh.engine.system.resources.assets.shaders.Shader;
...
import ru.alfabouh.engine.system.resources.assets.shaders.UniformBufferObject;
...
public class ShaderLoader {
    ...
    public ShaderManager createShaderManager(String shader, int types) {
        JGems.get().getLogManager().log("Creating shader " + shader);
    ...
    public void startShaders() {
        JGems.get().getLogManager().log("Compiling shaders!");
    ...
    public void destroyShaders() {
        JGems.get().getLogManager().log("Destroying shaders!");
        for (ShaderManager shaderManager : ShaderLoader.allShaders) {
