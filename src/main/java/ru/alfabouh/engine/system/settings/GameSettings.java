package ru.alfabouh.engine.system.settings;
...
import ru.alfabouh.engine.system.settings.objects.SettingChooseLanguage;
import ru.alfabouh.engine.system.settings.objects.SettingFloatBar;
import ru.alfabouh.engine.system.settings.objects.SettingIntSlots;
import ru.alfabouh.engine.system.settings.objects.SettingTrueFalse;
...
public class GameSettings {
    ...
    public void saveOptions() {
        JGems.get().getLogManager().log("Saving settings...");
        try {
        ...
        JGems.get().getLogManager().log("Settings successfully saved!");
    }
