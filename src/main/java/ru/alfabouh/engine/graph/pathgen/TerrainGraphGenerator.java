package ru.alfabouh.engine.graph.pathgen;
...
public class TerrainGraphGenerator {
    ...
    private Graph.GVertex tryPlaceVertex(Graph.GVertex current, double x, double y, double z) {
        ...
        rayResultCallback2.m_collisionFilterMask(btBroadphaseProxy.DefaultFilter & ~BodyGroup.PlayerFilter & ~BodyGroup.LiquidFilter & ~BodyGroup.GhostFilter & ~BodyGroup.DefaultByPassNavChecks);
        ...
        if (rayResultCallback.hasHit() && !rayResultCallback2.hasHit()) {
            ...
            if (rayResultCallback2.hasHit()) {
                ...
                rayResultCallback3.m_collisionFilterMask(btBroadphaseProxy.DefaultFilter & ~BodyGroup.PlayerFilter & ~BodyGroup.LiquidFilter & ~BodyGroup.GhostFilter & ~BodyGroup.DefaultByPassNavChecks);
