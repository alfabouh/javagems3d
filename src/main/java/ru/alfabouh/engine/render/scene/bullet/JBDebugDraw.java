...
public class JBDebugDraw extends btIDebugDraw {
    ...
    public void drawLine(btVector3 from, btVector3 to, btVector3 color) {
        ShaderManager debugShaders = ResourceManager.shaderAssets.debug;
        debugShaders.bind();
        debugShaders.getUtils().performProjectionMatrix();
        debugShaders.getUtils().performViewMatrix3d(TransformationManager.instance.getMainCameraViewMatrix());
