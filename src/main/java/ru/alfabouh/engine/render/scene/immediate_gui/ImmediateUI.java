package ru.alfabouh.engine.render.scene.immediate_gui;

import org.joml.Vector2f;
import org.joml.Vector2i;
import org.joml.Vector3f;
import ru.alfabouh.engine.JGems;
import ru.alfabouh.engine.render.scene.immediate_gui.elements.UIButton;
import ru.alfabouh.engine.render.scene.immediate_gui.elements.UIPictureSizable;
import ru.alfabouh.engine.render.scene.immediate_gui.elements.UIPictureStatic;
...
import ru.alfabouh.engine.render.scene.immediate_gui.elements.optionsUI.UICarousel;
import ru.alfabouh.engine.render.scene.immediate_gui.elements.optionsUI.UISlider;
...
public class ImmediateUI {
    ...
    public void shader(ShaderManager shaderManager) {
    ...
    public static float GET_SCREEN_NORMALIZED_SCALING() {
        double width = JGems.get().getScreen().getWidth();
        double height = JGems.get().getScreen().getHeight();
