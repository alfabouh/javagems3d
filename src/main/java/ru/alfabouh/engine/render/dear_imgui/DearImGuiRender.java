package ru.alfabouh.engine.render.dear_imgui;
...
public class DearImGuiRender {
    private final ShaderManager shaderManager;
    private DearImGuiMesh dearImGuiMesh;
    private TextureSample textureSample;
    private GLFWKeyCallback prevKeyCallback;

    public DearImGuiRender(Window window, GameCache gameCache) {
    ...
    private void createUIResources(GameCache gameCache, Vector2i windowSize) {
        ...
        this.dearImGuiMesh = new DearImGuiMesh();
    }
    ...
    private void drawGui(ControllerDispatcher controllerDispatcher) {
        ...
        ImGui.begin("Output", ImGuiWindowFlags.AlwaysVerticalScrollbar);
        String[] textLines = JGemsLogging.consoleText().split("\n");
    ...
    public DearImGuiMesh getImguiMesh() {
