...
public abstract class PhysProp extends PhysEntity {
    private final MeshDataGroup meshDataGroup;
    private boolean canBeDestroyed;

    public PhysProp(World world, String name, RigidBodyObject.PhysProperties properties, Vector3f pos, Vector3f rot, Vector3f scale, MeshDataGroup meshDataGroup) {
        super(world, name, properties, pos, rot, scale);
        this.meshDataGroup = meshDataGroup;
        this.canBeDestroyed = true;
    }

    public PhysProp(World world, String name, RigidBodyObject.PhysProperties properties, Vector3f pos, Vector3f rot, MeshDataGroup meshDataGroup) {
        this(world, name, properties, pos, rot, new Vector3f(1.0f), meshDataGroup);
    }

    public PhysProp(World world, String name, RigidBodyObject.PhysProperties properties, Vector3f pos, MeshDataGroup meshDataGroup) {
        this(world, name, properties, pos, new Vector3f(0.0f), new Vector3f(1.0f), meshDataGroup);
    }

    public PhysProp setCanBeDestroyed(boolean flag) {
