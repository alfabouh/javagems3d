...
import ru.alfabouh.jgems3d.engine.physics.colliders.DynamicMeshCollider;
...
public class BtDynamicMeshBody extends BtBody {
    ...
    public BtDynamicMeshBody(MeshDataGroup meshDataGroup, World world, @NotNull Vector3f pos, @NotNull Vector3f rot, @NotNull Vector3f scale, String itemName) {
        super(world, pos, rot, scale, itemName);
        this.meshDataGroup = meshDataGroup;
    }

    public BtDynamicMeshBody(MeshDataGroup meshDataGroup, World world, @NotNull Vector3f pos, @NotNull Vector3f rot, String itemName) {
        this(meshDataGroup, world, pos, rot, new Vector3f(1.0f), itemName);
    }

    public BtDynamicMeshBody(MeshDataGroup meshDataGroup, World world, @NotNull Vector3f pos, String itemName) {
