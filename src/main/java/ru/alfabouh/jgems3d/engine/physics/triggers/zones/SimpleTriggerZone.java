...
public class SimpleTriggerZone implements ITriggerZone {
    ...
    public void onSpawn(IWorld iWorld) {
        ...
        SystemLogging.get().getLogManager().log("Created news ITrigger zone: Location=" + this.getZone().getLocation() + " | Size=" + this.getZone().getSize());
    }

    public void onDestroy(IWorld iWorld) {
        this.collisionShape.deallocate();
        this.ghostObject = null;
        SystemLogging.get().getLogManager().log("Destroyed ITrigger zone: Location=" + this.getZone().getLocation() + " | Size=" + this.getZone().getSize());
    }
