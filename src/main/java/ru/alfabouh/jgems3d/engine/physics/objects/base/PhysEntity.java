...
public abstract class PhysEntity extends CollidableWorldItem implements IWorldDynamic {
    ...
    public PhysEntity(World world, String name, RigidBodyObject.PhysProperties properties, Vector3f pos, Vector3f rot, Vector3f scale) {
        super(world, properties, pos, rot, scale, name);
        this.velocityVector = new Vector3f(0.0f);
    }

    public PhysEntity(World world, String name, RigidBodyObject.PhysProperties properties, Vector3f pos, Vector3f rot) {
        this(world, name, properties, pos, rot, new Vector3f(1.0f));
    }

    public PhysEntity(World world, String name, RigidBodyObject.PhysProperties properties, Vector3f pos) {
