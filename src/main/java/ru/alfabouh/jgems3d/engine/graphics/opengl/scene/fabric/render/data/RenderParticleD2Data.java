...
public class RenderParticleD2Data extends RenderObjectData {
    ...
    public RenderParticleD2Data(IRenderFabric renderFabric, @NotNull Class<? extends AbstractSceneItemObject> aClass, @NotNull JGemsShaderManager shaderManager, ParticleTexturePack particleTexturePack, boolean isBright) {
