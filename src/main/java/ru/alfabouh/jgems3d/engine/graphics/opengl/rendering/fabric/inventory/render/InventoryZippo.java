package ru.alfabouh.jgems3d.engine.graphics.opengl.rendering.fabric.inventory.render;
...
public class InventoryZippo extends InventoryItem {
    ...
    public InventoryZippo() {
        ...
        material1.setDiffuse(JGemsResourceManager.textureAssets.zippo1);
        material1.setEmissive(JGemsResourceManager.textureAssets.zippo1_emission);
        material2.setDiffuse(JGemsResourceManager.textureAssets.zippo2);
    ...
    @Override
    public void onRender(float partialTicks, SceneRenderBase sceneRenderBase, ru.alfabouh.jgems3d.engine.inventory.items.InventoryItem inventoryItem, RenderInventoryItemData renderInventoryItemData) {
    ...
    @Override
    public void preRender(SceneRenderBase sceneRenderBase, ru.alfabouh.jgems3d.engine.inventory.items.InventoryItem inventoryItem, RenderInventoryItemData renderInventoryItemData) {
    ...
    @Override
    public void postRender(SceneRenderBase sceneRenderBase, ru.alfabouh.jgems3d.engine.inventory.items.InventoryItem inventoryItem, RenderInventoryItemData renderInventoryItemData) {
