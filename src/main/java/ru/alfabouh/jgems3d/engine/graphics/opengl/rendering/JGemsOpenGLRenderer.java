...
import ru.alfabouh.jgems3d.engine.graphics.opengl.rendering.programs.textures.TextureProgram;
...
import ru.alfabouh.jgems3d.engine.graphics.opengl.rendering.scene.groups.*;
...
//
    ...
    public void renderSceneWithPSXPostProcessing(Model<Format2D> model) {
        ...
        this.getPostProcessingShader2().performUniform("panic", 0.1f);
        ...
        GL30.glActiveTexture(GL30.GL_TEXTURE3);
        JGemsResourceManager.textureAssets.screen.bindTexture();
