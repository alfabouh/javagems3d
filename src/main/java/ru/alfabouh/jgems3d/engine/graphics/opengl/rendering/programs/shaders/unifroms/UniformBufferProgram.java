package ru.alfabouh.jgems3d.engine.graphics.opengl.rendering.programs.shaders.unifroms;
...
public class UniformBufferProgram {
    ...
    public boolean createUniformBuffer(int binding, int bytes) {
        ...
        if (uniformLocation < 0) {
            SystemLogging.get().getLogManager().warn("Could not find uniform-buffer " + this.getName());
            return false;
        }
