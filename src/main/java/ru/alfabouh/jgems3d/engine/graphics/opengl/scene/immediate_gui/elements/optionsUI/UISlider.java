...
import ru.alfabouh.jgems3d.engine.graphics.opengl.scene.immediate_gui.elements.UIPictureStatic;
...
import ru.alfabouh.jgems3d.engine.graphics.opengl.scene.immediate_gui.elements.base.UIScalable;
...
public class UISlider extends UIInteractiveElement implements UIScalable {
    ...
    public void render(float partialTicks) {
        ...
        UIPictureStatic line = new UIPictureStatic(JGemsResourceManager.renderAssets.gui1, new Vector2i(this.getPosition()).add(0, (int) (3.0f * this.getScaling().y)), new Vector2f(0.0f, 13.0f), new Vector2f(100.0f, 1.0f), this.getZValue());
        UIPictureStaticSelectable brick = new UIPictureStaticSelectable(JGemsResourceManager.renderAssets.gui1, new Vector2i(this.getPosition()).add((int) (this.getOptionValue() * this.getScaling().mul(98).x), 0), new Vector2f(0.0f, 14.0f), new Vector2f(2.0f, 7.0f), this.getZValue());
