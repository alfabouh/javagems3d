...
public class UIArrow extends UIInteractiveElement {
    ...
    public UIArrow(int vector, @NotNull SettingSlot settingIntSlots, @NotNull Vector2i position, float zValue) {
        ...
        this.imageStaticUI = new UIPictureStaticSelectable(JGemsResourceManager.textureAssets.gui1, position, new Vector2f(vector == -1 ? 5.0f : 0.0f, 22.0f), new Vector2f(this.size), zValue);
