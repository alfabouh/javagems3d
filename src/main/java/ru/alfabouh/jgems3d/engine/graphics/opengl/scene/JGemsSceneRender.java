...
public class JGemsSceneRender {
    ...
    private void updateUbo() {
        JGemsSceneRender.getGameUboShader().performUniformBuffer(JGemsResourceManager.globalShaderAssets.Misc, new float[]{JGems.get().getScreen().getRenderTicks()});
        ...
        value1Buffer.flip();
        JGemsSceneRender.getGameUboShader().performUniformBuffer(JGemsResourceManager.globalShaderAssets.Fog, value1Buffer);
