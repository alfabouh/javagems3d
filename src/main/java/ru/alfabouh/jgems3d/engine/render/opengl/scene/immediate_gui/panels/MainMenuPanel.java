...
public class MainMenuPanel extends AbstractPanelUI {
    ...
    public void drawPanel(ImmediateUI immediateUI, float partialTicks) {
        ...
        ResourceManager.shaderAssets.menu_psx.performUniform("offset", JGemsSceneRender.PSX_SCREEN_OFFSET);
        ResourceManager.shaderAssets.menu_psx.getUtils().performOrthographicMatrix(model);
    ...
    private void renderContent(ImmediateUI immediateUI, Window window, float partialTicks) {
        ...
        immediateUI.textUI(JGems.get().toString(), ResourceManager.renderAssets.standardFont, new Vector2i(10, windowH - 35), 0x00ff00, 0.5f);
        ...
        if (MainMenuPanel.showBlood) {
            ...
            immediateUI.textUI(gOverText, ResourceManager.renderAssets.standardFont, new Vector2i(windowW / 2 - tWidth / 2, windowH / 2 - tHeight / 2 - 100), 0xff0000, 0.5f);
            ...
            int tWidth = ImmediateUI.getTextWidth(ResourceManager.renderAssets.standardFont, gOverText);
            int tHeight = ImmediateUI.getFontHeight(ResourceManager.renderAssets.standardFont);
            immediateUI.textUI(gOverText, ResourceManager.renderAssets.standardFont, new Vector2i(windowW / 2 - tWidth / 2, windowH / 2 - tHeight / 2 - 100), 0x00ff00, 0.5f);
        }
    }
    ...
    public static void renderMenuBackGround(boolean showBlood, Vector3f color) {
        ...
        ResourceManager.shaderAssets.menu.getUtils().performOrthographicMatrix(model);
        GL30.glActiveTexture(GL30.GL_TEXTURE0);
