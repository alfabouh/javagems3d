...
public class LeaveConfirmationPanel extends AbstractPanelUI {
    ...
    public void drawPanel(ImmediateUI immediateUI, double partialTicks) {
        ...
        immediateUI.textUI(text, ResourceManager.renderAssets.standardFont, new Vector2i(windowW / 2 - textSize / 2, windowH / 2 - 60), 0xffffff, 0.5f);

        immediateUI.buttonUI(JGems.get().I18n("menu.confirm.yes"), ResourceManager.renderAssets.standardFont, new Vector2i(windowW / 2 + 5, windowH / 2 ), new Vector2i(200, 60), 0xffffff, 0.5f)
                .setOnClick(() -> {
                    JGems.get().destroyGame();
                });
        immediateUI.buttonUI(JGems.get().I18n("menu.confirm.no"), ResourceManager.renderAssets.standardFont, new Vector2i(windowW / 2 - 205, windowH / 2 ), new Vector2i(200, 60), 0xffffff, 0.5f)
                .setOnClick(() -> {
