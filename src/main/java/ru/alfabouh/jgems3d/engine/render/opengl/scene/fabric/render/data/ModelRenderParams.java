...
public final class ModelRenderParams {
    ...
    private JGemsSceneRender.RenderPass renderPass;

    public ModelRenderParams(boolean shadowCaster, boolean passShadowsInfoInRender, boolean hasTransparency, @NotNull JGemsShaderManager shaderManager) {
    ...
    private void setForwardRenderPass() {
        this.setRenderPass(JGemsSceneRender.RenderPass.FORWARD);
    }

    private void setDeferredRenderPass() {
        this.setRenderPass(JGemsSceneRender.RenderPass.DEFERRED);
    }

    public JGemsSceneRender.RenderPass getRenderPassToRenderIn() {
    ...
    public ModelRenderParams setRenderPass(JGemsSceneRender.RenderPass renderPass) {
