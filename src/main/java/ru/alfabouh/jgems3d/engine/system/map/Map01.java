...
import ru.alfabouh.jgems3d.engine.physics.entities.enemy.EntityManiac;
import ru.alfabouh.jgems3d.engine.physics.entities.items.EntityCassetteItem;
import ru.alfabouh.jgems3d.engine.physics.entities.items.EntityCdItem;
import ru.alfabouh.jgems3d.engine.physics.entities.items.EntityItem;
import ru.alfabouh.jgems3d.engine.physics.entities.items.EntitySodaItem;
...
import ru.alfabouh.jgems3d.engine.physics.entities.prop.WorldDoor;
...
public class Map01 implements IMapLoader {
    ...
    public void addSounds(World world) {
        JGems.get().getSoundManager().playSoundAt(ResourceManager.soundAssetsLoader.drips, SoundType.WORLD_AMBIENT_SOUND, 1.5f, 5.0f, 4.0f, new Vector3d(-1.5d, -19.0d, -23.0d));
        JGems.get().getSoundManager().playSoundAt(ResourceManager.soundAssetsLoader.map_ambience1, SoundType.WORLD_AMBIENT_SOUND, 2.0f, 3.0f, 3.0f, new Vector3d(20.5d, 10.0d, -25.0d));
    }
