...
import ru.alfabouh.jgems3d.engine.graphics.opengl.rendering.fabric.objects.render.RenderProp;
...
public class Map03 implements IMapLoader {
    ...
    public MapInfo getLevelInfo() {
        ...
        skyProp.setSunColor(new Vector3f(1.0f, 0.95f, 0.88f));
