...
public class WGluingRenderProcessor extends IRenderProcessor.Template {
    ...
    public WGluingRenderProcessor(@NotNull FBOTexture2DProgram inColorTransparency, @NotNull FBOTexture2DProgram inColorScene, @NotNull OpenGLRenderer openGLRenderer, @NotNull JGemsShaderManager gluingShader) {
