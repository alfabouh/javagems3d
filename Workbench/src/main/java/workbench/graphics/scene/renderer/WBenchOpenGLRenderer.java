...
public class WBenchOpenGLRenderer extends OpenGLRenderer implements IDearUIImp, IProjectActrionsCallback {
    ...
    @Override
    public void onOpenedProject(WBenchResourceManager resourceManager, @NotNull Project project) {
